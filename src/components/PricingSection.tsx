...
const plans = [
  {
    ...
    features: [
      ...
      { text: 'Metrónomo y afinador básico', included: true },
      { text: 'Sala de Práctica completa', included: false },
      { text: 'Comunidad y acordes avanzados', included: false },
    ],
    popular: false,
    color: 'border-border',
  ...
  },
  {
    ...
    features: [
      ...
      { text: 'Sala de Práctica: Rítmica, Batería y Progresiones', included: true },
  ...
  },
  {
    ...
    features: [
      ...
      { text: 'Galería de acordes avanzados (PDF descargable)', included: true },
      { text: 'Grabaciones de práctica → enviar al maestro', included: true },
      { text: 'Comunidad estilo Facebook (publicar, likes, comentarios)', included: true },
      { text: 'Feedback 1:1 mensual + Certificados oficiales', included: true },
    ],
    popular: true,
