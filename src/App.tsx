  ...
  <BrowserRouter>
    <Suspense fallback={<PageFallback />}>
      <Routes>
        ...
        <Route path="/para-maestros" element={<StudioPlansPage />} />
        <Route path="/software-para-maestros" element={<StudioPlansPage />} />
        ...
        <Route path="/clases/:code" element={<WithData><LeadCapturePage /></WithData>} />
        <Route path="/baja" element={<WithData><UnsubscribePage /></WithData>} />
